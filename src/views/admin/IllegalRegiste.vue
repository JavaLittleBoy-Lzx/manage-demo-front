...
import { WarningFilled, Search, ArrowDown, View, Download, RefreshRight, Location, Clock, Phone, Picture } from '@element-plus/icons-vue';
...
const loadCommunityList = () => {
    ...
    // 🔐 直接使用用户管理的车场名称作为选项
    if (isAdmin.value) {
        // 管理员：如果需要显示所有车场，可以调用API，这里简化为显示管理车场
        console.log('✅ 管理员用户，加载管理车场');
