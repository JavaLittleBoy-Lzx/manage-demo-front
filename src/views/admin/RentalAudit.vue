  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i> 租赁审批
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
        ...
        <el-table-column label="审批状态" prop="auditStatus" align="center">
          <template #default="scope">
            ...
            <el-tag type="warning" v-else-if="scope.row.audiusStatus === 2">已通过</el-tag>
          ...
          <el-table-column label="操作" width="180" align="center" fixed="right">
            <template #default="scope">
              <el-button type="text" icon="el-icon-edit" @click="handleEdit(scope.row)"
                :disabled="scope.row.audiusStatus === 1 ? false : true">审核
              </el-button>
    ...
    <div>
      <el-dialog title="申请" v-model="dialogVisible" width="35%" :before-close="handleClose">
        <el-form :model="form.data" ref="formRef" :rules="rules" label-width="100px">
          ...
          <el-form-item label="使用部门">
            <el-input v-model="orderdepartmentName" style="width: 40%;" disabled></el-input>
          </el-form-item>
          <el-form-item prop="applicationTime" label="租赁开始时间">
            <el-date-picker v-model="form.data.leaseTime" type="date" placeholder="选择一个日期" format="YYYY-MM-DD hh:mm:ss"
              value-format="YYYY-MM-DD hh:mm:ss" clearable disabled>
            </el-date-picker>
          </el-form-item>
          <el-form-item prop="applicationTime" label="设备预还时间" disabled>
          ...
          <el-form-item label="审核情况 ">
            <el-radio-group v-model="form.data.audiusStatus">
...
const getDevice = () => {
  request.get("/parking/device/listAll").then((res) => {
