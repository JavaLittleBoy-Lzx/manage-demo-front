  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-location"></i> 客户管理
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      <div class="handle-box">
        <el-form :inline="true" :model="query" class="demo-form-inline" label-width="60px">
          <el-form-item label-width="60px" label="客户">
            <el-input v-model="query.name" placeholder="客户名称" class="handle-input mr10" clearable></el-input>
          </el-form-item>
          <el-form-item label-width="60px" label="编码">
            <el-input v-model="query.code" placeholder="客户编码" class="handle-input mr10" clearable></el-input>
          </el-form-item>
        ...
        <el-table-column>
          <el-table-column label="操作" width="180" align="center" fixed="right">
            <template #default="scope">
              <el-button type="text" icon="el-icon-edit" @click="handleEdit(scope.row.customerId)">编辑
              </el-button>
              <el-button type="text" icon="el-icon-delete" class="red"
                @click="handleDelete(scope.$index, scope.row.customerId)">删除</el-button>
            </template>
          </el-table-column>
        </el-table-column>
      </el-table>
...
export default {
  ...
  setup() {
    ...
    // 新增操作
    const handleAdd = () => {
      router.push("/admin/parking/addCustomer");
    };
    ...
    const handleEdit = (id) => {
      console.log(id)
      router.push({ path: "/admin/parking/addCustomer", query: { id: id } });
    };
